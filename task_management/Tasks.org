...
#+BEGIN_SRC python :results output raw replace drawer :var tab = test_table start_date = "" task_time="19:00" tags = ""
...
:LOGBOOK:
CLOCK: [2025-01-19 Sun 05:57]--[2025-01-19 Sun 06:17] =>  0:20
:END:
#+BEGIN: clocktable :scope subtree :maxlevel 2
#+CAPTION: Clock summary at [2025-01-19 Sun 06:17]
| Headline     | Time   |
|--------------+--------|
| *Total time* | *0:00* |
#+END:
