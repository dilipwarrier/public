...
#+BEGIN_SRC python :results output raw :var tab = test_table start_date = "" task_time="20:00" tag = ""
  ...
  if len(tag) > 0:
      # Add colon identifiers for tag if it is specified
      tag = ":" + tag + ":"
