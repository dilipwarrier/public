...
* Subjective well-being                                              :Review:
  ...
  components.
    - Affective balance :: The difference between positive affects or
      feelings and negative affects. This is a measure of the
...
#+begin_quote
    ...
    can cause dissatisfaction with life, and it may take time for
    ...
    homemaker or grandparent. When the person enjoys their work,
    ...
    important goals and fails to make adequate progress toward them,
    ...
    There is no single key to life satisfaction, but rather a recipe that
