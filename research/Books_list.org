...
** DONE Add an option in recommend_book.py to exclude a genre (e.g. -xg textbook) :Software:
   :PROPERTIES:
   :EFFORT:  00:15
   :BENEFIT: 10
   :RATIO: 0.40
...
** DONE Allow multiple genres in recommend_book.py (e.g. -g"textbook,management") :Software:
   :PROPERTIES:
   :EFFORT:  00:15
   :BENEFIT: 10
   :RATIO: 0.40
...
** DONE Add an option in recommend_book.py to list by status (e.g. -s reading) :Software:
   :PROPERTIES:
   :EFFORT:  00:15
   :BENEFIT: 10
   :RATIO: 0.40
