...
#+begin_src shell :results drawer
../item_recommender/recommend_book.py -r 100 -g books-to-read-again books_list.csv
#+end_src
...
Guns,Germs,and Steel: The Fates of Human Societies: Jared Diamond        (4.0, society,books-to-read-again)
...
Armchair Economist: Economics & Everyday Life     : Steven E. Landsburg  (3.8, economics,books-to-read-again)
:end:
