...
future. Note that, for instance, a fish does not necessarily have this
...
However, this is unethical if the person expressed a desire to
continue to live. In that case, that person's preferences take
precedence. It may also be unethical to kill [[id:1c737d8a-18df-4b71-849d-dacfbcc1c37d][a baby]] who is not
conscious yet but possesses the ability to become conscious and
...
the NPV to that person is about $27k at a discount rate of 3.5%.

An alternate model is that a human life is worth roughly $1M over a
lifetime or, say, $15k/year for 70 years. By spending $5k now, this is
the utility that is realized. This provides an NPV of
$390k at a discount rate of 3.5%.
...
immediately. Money lenders continue to operate and charge much higher
interests even in areas where such institutions are active.

You can think of investments and returns as the X and Y
axes of a graph with an S curve. Poor people exist at the bottom of
the S curve. Each investment results in a return that is less than the
investment and, hence, a poor person ends up poorer. Rich people may
be on the steep part of the S curve where each investment results in a
return that is significantly higher. This has also been popularized as
the Matthew effect.
...
** Matthew 13:11-12: For to him who has will more be given, and he will have abundance; but from him who has not, even what he has will be taken away. :quotes:
