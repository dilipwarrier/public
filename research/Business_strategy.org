...
* Good strategy, bad strategy by Richard Rumelt                      :Review:

There are three main pathways to bad strategy - choosing to do many
things rather than a few focused things, using lazy templatized
...
A diagnosis should replace complex reality with a simpler story that
shows the crucial aspects of the problem.
...
* Remaining sections
:PROPERTIES:
:ID:       c1c348b4-b32a-4588-9826-ba6d9851c200
:END:
