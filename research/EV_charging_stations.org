...
|--------+------+------+-------+---------------|
| Date   |   L2 | DCFC | Total | Annual growth |
|--------+------+------+-------+---------------|
| Dec-25 | 65.2 | 14.2 |  79.4 |         10.3% |
| Dec-24 | 60.0 | 12.0 |  72.0 |               |
|--------+------+------+-------+---------------|
#+TBLFM: $4=vsum($2..$3);%.1f::$5=100*($4-@+1$4)/@+1$4;%.1f%%

Source: [[https://afdc.energy.gov/stations#/find/nearest?fuel=ELEC][DoE site]]

*** TODO Update [[id:9f94c234-8138-48c1-9e67-7a97a066d91c][table]] with latest information on charging sites in the US :Learning:
SCHEDULED: <2027-01-09 Sat +52w>
:PROPERTIES:
:EFFORT:  00:15
:BENEFIT: 10
:RATIO: 0.40
:LAST_REPEAT: [2026-06-29 Mon 20:36]
:END:


- State "DONE"       from "TODO"       [2026-06-29 Mon 20:36]
