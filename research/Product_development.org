...
* Product versus feature teams                                   :MartyCagan:
  ...
  1. Value risk (will people use it?)
  2. Viability risk (will the solution work for our business?)
  3. Usability risk (will people figure out how to use it?)
  4. Feasibility risk (can we build it with the time, skills and technology we have?)
