...
- Individuals must be able to practise as individual contributors
  throughout their career. Managers must set up compensation and
  recognition such that individuals can keep practising their
  expertise.
- All must be aware of the tools trap. They must not assume that tools
...
Our Type 1 automatically perceives the first line to be
...
If people first do an effortful task like eating a vegetable while resisting
a cookie and are then asked to do a difficult cognitive task, they
will give up on the cognitive task earlier. The first task causes a
temporary depletion of effort that affects our performance on the second one.
Physiologically, The nervous system uses a lot of glucose, especially for effortful
activities. Replenishing glucose in between such effortful tasks can
improve performance on later tasks.
...
- Type 1 processing or the autonomous mind
- Type 2 processing or the algorithmic mind
- The reflective or rational mind, which decides when the judgments of the
  autonomous mind will suffice versus when to employ the algorithmic
  mind.

He further suggested that the reflective mind determines how rational
a person is and has low correlation with the algorithmic mind.
