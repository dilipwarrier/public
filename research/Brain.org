...
feedback loop that is critical to success.

A good example is doing your tax returns. Each year, you follow a
fixed process to do your taxes. However, most people stay at the
Novice phase in the process of filing tax returns.
...
From the Proficient phase onwards, you start to use reflection and
...
From the Proficient through the Expert phases, he practitioner
realizes that they are part of a system and yet they are not bogged
down by the complexity of the overall system. They are able to
identify the key elements of the system that provide leverage for the
activity at hand.
...
- Individuals must be able to practise as individual practitioners
  throughout their career. Managers must set up compensation and
  recognition such that individuals can keep practising their
  expertise.
- Practitioners must be aware of the tools trap. They must not assume that tools
  alone can bring about process excellence.
...
3. Don't expect students to "figure things out for themselves."
...
7. If your students do 95%+ of their problems correctly, they are
   ...
   forget unless you periodically give them refresher work.
...
The Focused mode is most useful when you are executing on
...
The Diffuse mode allows the brain to work on the tough
...
Reasoning can take us to almost any conclusion we want to reach. We
ask "Can I believe it?" when we want to believe something, but we ask
"Must I believe it?" when we don't want to believe. The answer is
...
confirmation bias is a built-in feature and not a bug that can be
removed.
...
For instance, there is very little correlation between wealth and
happiness beyond a certain point. Paraplegics are not as unhappy as
non-paraplegics think they are. Living in California won't make you as
happy as you think it will.
...
egg: the first idea gets in and then the mind shuts down.
...
ignore the failure rate of previous similar projects.
...
we assumed that the problem of securing planes is
...
:PROPERTIES:
:ID:       eb1e2a5f-ba0d-4533-bfd5-ff8489a8cca8
:END:

The human brain has two modes of thinking, Type 1 and
Type 2 processing. Type 1 operates automatically and quickly, with no effort
and no sense of control. Type 2 is effortful and algorithmic. It
involves subjective experiences of agency, choice, and
concentration. It is required to exercise self-control.

Daniel Kahneman refers to these as System 1 and System 2 thinking but
the original authors, Evans and Stanovich, prefer to call them Type 1
and Type 2 processing in their Dual-Process Theory. This nomenclature
avoids the trap of thinking of these as separate systems.

When we think of ourselves, we think of Type 2 processing. However,
Type 1 is the unsung hero. Type 1 processing continuously generates
impressions and intuitions based on the outside world. It feeds those
suggestions to Type 2 processing. Type 2 usually adopts them as is.
Type 2 processing only kicks in when Type 1 can not form an
explanation for a phenomenon in the real world.

Type 1 can detect simple relations e.g. the son is much taller than
the father. However, it cannot deal with multiple criteria and it
cannot use purely statistical or logical information.

Consider the following problem:
#+begin_example
If a bat and a ball together cost $1.10 and the bat costs $1
more than the ball, how much does the ball cost?
#+end_example

Your Type 1 processing will immediately respond that the ball costs 10
cents. If you engaged Type 2 and did the math, you'd realize that
the correct answer is 5 cents. Further, you'll realize that Type 1
ignored the part of the question that said "more than the ball",
leading to the error.

Another example is the Muller-Lyer visual illusion, shown below.

[[file:Screenshot 2025-12-10 074744.png]]

Type 1 processing automatically perceives the first line to be
longer. In fact, the two lines are of equal length. We can not
turn off this automatic perception by our Type 1 even if we are
aware of the error.

Type 1 is generally quite accurate in its predictions of familiar
situations. However, it has biases and makes systematic errors in
specific circumstances like the ones above.

It is not possible to constantly question Type 1 thinking. Instead,
we must be aware of the limitations of Type 1 thinking when both the
chances and the costs of making mistakes are high. In those cases, we
must learn to slow down and employ Type 2 thinking.

Type 2 processing require attention and the brain has a limited
attention budget. As a result, it is impossible to multi-task Type 2
activities e.g. doing a complex multiplication problem while turning
left in a car.

If people first do an effortful task like eating a vegetable while
resisting a cookie and are then asked to do a difficult cognitive
task, they will give up on the cognitive task earlier. The first task
causes a temporary depletion of effort that affects our performance on
the second one.

Physiologically, the nervous system uses a lot of glucose, especially
for effortful activities. Replenishing glucose in between such tasks
can improve performance on later tasks.

** Type 3 processing
:PROPERTIES:
:ID:       cd736465-93cd-47e1-b7ca-41c2a8a38ca7
:END:

Keith Stanovich theorizes that the thinking mind consists of three parts:
Type 1 - Autonomous mind
Type 2 - Algorithmic mind
Type 3 - Reflective mind

The reflective mind decides when the judgments of the autonomous mind
will suffice versus when to employ the algorithmic mind. He further
suggested that the reflective mind has low correlation with the
algorithmic mind.

** References

- Daniel Kahneman, "Thinking fast and slow"
- Jonathan Evans and Keith Stanovich, "Dual-Process Theories of Higher
  Cognition", https://doi.org/10.1177/1745691612460685

* Moral reasoning                                                    :Review:

The principles of moral psychology are:
1. Intuitions come first, reasoning comes second.
...
broader and includes the ethics of community and divinity in most other
...
People have hyper-sensitive agency detectors: they see an agent behind
...
See also [[id:eb1e2a5f-ba0d-4533-bfd5-ff8489a8cca8][System 1 and System 2 thinking]].
...
Below that is a broader section of the things you know you don't
know. You are aware that these things exist but you haven't delved
into them in detail. Perhaps you have a novice level knowledge of them
or you just have awareness that they exist.
...
* Consciousness
:PROPERTIES:
:ID:       1c737d8a-18df-4b71-849d-dacfbcc1c37d
:END:

A baby typically does not show signs of consciousness until well into
the third trimester. They may show reflexive reactions to stimuli but
those are not conscious reactions.

** References

- Christoph Koch, "Then I am myself the world"
...
way of describing the world depends upon the goal of the description.
...
2. Each of them is unhappy if they are surrounded by 70% or more of
   the other, and
3. When they are unhappy, they are able to move to a random open slot
then you reach an equilibrium where the Xs and Os are largely
segregated. This could be interpreted as membranes around the Xs and
Os.
