#+TITLE: Interesting thoughts/results in AI
#+FILETAGS: :AI:Technology:
...
Reached [[https://www.coursera.org/learn/implementation-of-genai-agents/supplement/2RDEr/hands-on-learning-hol-implementing-core-ai-agent-functionalities][here]] but gave up. The material is very bad.
...
** Archive                                                          :ARCHIVE:
*** DONE [#A] Work on Coursera specialization on [[https://www.coursera.org/specializations/build-genai-applications-and-agents][Building GenAI applications and agents]] :Learning:
...
:END:
- State "DONE"       from "TODO"       [2026-04-13 Mon 20:31]
