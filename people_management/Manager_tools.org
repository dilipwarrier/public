...
See also [[id:7d91bef7-86df-43c5-95f5-743441c8578a][See one, do one, teach one]].
...
:PROPERTIES:
:ID:       7d91bef7-86df-43c5-95f5-743441c8578a
:END:

Andragogy is adult learning as opposed to pedagogy or child
learning. Children learn through structured classroom
learning. However, adults learn by doing and need to understand how
what they're learning applies to their daily life.

This process does not require long training sessions or a lot of
training material. Instead, you should just let your direct observe
you doing the practice and, then, you should let them try it
out. However, you have to have a tolerance for mistakes.

In this way, you can accelerate learning in your organization and help
develop your directs.
...
You cannot skip any of these steps nor can you prematurely end
...
2. Preferences
   ...
   - Wants you to make decisions or wants to be aware of decisions?
...
3. Strengths and weaknesses
   ...
   - Become a safety net for her so that you smooth over her
     vulnerabilities.
...
job search, not just one. The channels are as follows.
  ...
  - Connections :: Maintain a healthy list of networking
...
Layoffs and firing are a fact of corporate life in every industry and
at every level. Getting fired can be a liberating experience; you just
go find another job. However, you need to prepare in advance.

Cardinal rule: get 6 months of liquidity in your personal finances
now! You need to be prepared for a period of not finding the next
job. That way, you remove the stress of worrying about cash flow and
can focus on the job search.
