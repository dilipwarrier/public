...
*** A company change with a promotion is unlikely
    ...
    company change. There are only two exceptions to this rule and
    they hold in very rare circumstances.

    1. You are moving from a big company to a smaller one. In a
    ...
    2. You are being directly sought by the hiring manager in the new
       company.
