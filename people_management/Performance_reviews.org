...
#+CALL: ../task_management/Tasks.org:generate_tasks_from_offset(tab = Performance_review_tasks, start_date="2024-01-01")

#+RESULTS:
:results:
*** TODO Make 1-1s with directs into goal creation meetings
    SCHEDULED: <2024-01-05 Fri 20:00>
   :PROPERTIES:
   :EFFORT: 00:15
   :BENEFIT: 10
   :RATIO: 0.40
...
*** TODO Make 1-1s with directs into mid-quarter goal progress check-in meetings
    SCHEDULED: <2024-02-10 Sat 20:00>
   :PROPERTIES:
   :EFFORT: 00:15
   :BENEFIT: 10
   :RATIO: 0.40
...
*** TODO Complete my mid-quarter goal progress check-in
    SCHEDULED: <2024-02-15 Thu 20:00>
   :PROPERTIES:
   :EFFORT: 00:15
   :BENEFIT: 10
   :RATIO: 0.40
